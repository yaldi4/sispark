...
@section('content')
    ...
    <div class="col-md-4 col-md-offset-1">
        {{Form::open(array('route'=>'op.masuk','method'=>'POST','id'=>'cari','class'=>'form-horizontal ajax','data-refresh'=>'.hasilcari'))}}
        ...
        {{Form::close()}}
        <br>
        <form class="form-horizontal ajax" method="POST" id="hasilcari" action="">
            <!-- Text input-->
            <div class="form-group">
                <label for="nama">Nama</label>
                <input class="form-control input-md hasilcari" placeholder=" " autocomplete="off" name="nama" type="text" value="" id="nama" data-refresh-url=""></div>

            <div class="form-group">
                <label for="nopol">No Polisi</label>
                <select class="form-control hasilcari" id="kendaraan_id" name="kendaraan_id" data-refresh-url=""><option value="" selected="selected">Pilih</option></select>
            </div>
